...
class Terraform:
    ...
    def destroy(
        self,
        dir_or_plan: Optional[str] = None,
        destroy_flag: Type[TerraformFlag] = IsFlagged,
        ...
        **kwargs,
        ...
        """
        default = kwargs.copy()
        default["destroy"] = destroy_flag
        default["auto_approve"] = auto_approve
        options = self._generate_default_options(default)
        args = self._generate_default_args(dir_or_plan)
        return self.cmd("apply", *args, **options)
    ...
    def cmd(
        ...
        **kwargs,
        ...
        # logger.info("return code",ret_code)
        ...
        # if ret_code == 1  and raise_on_error:
